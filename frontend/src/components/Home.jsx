      ...
      <header className="shadow-sm bg-white sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 items-center">
            ...
            <button onClick={onLogout} className="rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-primary hover:text-primary">
              Logout
            </button>
          </nav>
    ...
    <div className="md:hidden">
      <button aria-expanded={open} aria-controls="mobile-menu" onClick={()=>setOpen(v=>!v)} className="p-2 rounded-md border">
        ...
        <div id="mobile-menu" className="absolute right-4 top-20 w-64 bg-white rounded-md shadow-lg py-4">
          ...
          <button
            onClick={onLogout}
            className="w-full text-left block px-4 py-2 hover:bg-slate-50 text-sm font-semibold text-slate-700"
          >
            Logout
          </button>
        </div>
